...
const envSchema = z.object({
    ...
    DATABASE_ID_DEFAULT: z.enum(identityTypeSupported, { error: `Defina um padrão de id para os registros do banco contindos nesta lista ${identityTypeSupported.join(',')}` }).default("uuidv7"),
