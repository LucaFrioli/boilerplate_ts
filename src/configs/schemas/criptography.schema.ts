...
const secureCryptographicKeySchema = z.union([hexKeySchema, base64KeySchema], {
	error: () => ({
		message: 'A chave deve ser codificada em Hexadecimal ou Base64 válido contendo pelo menos 256 bits (32 bytes) de entropia para evitar força bruta.'
	})
});
...
export const criptographyEnvValidationSchema = z.object({
	...
	CRIPTOGRAPHY_SINGATURE_DIGESTOR: z.enum(supportedDigestCriptographyAlgs, {
